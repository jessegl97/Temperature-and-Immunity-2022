...
```
## `summarise()` has grouped output by 'dpi'. You can override using the `.groups`
## argument.
```
...
##      dpi groups        count
##    <int> <fct>         <int>
##  1   -28 Warm Control     10
##  2   -28 Warm Infected    14
##  3   -28 Cold Control     10
##  4   -28 Cold Infected    14
##  5   -12 Warm Control     10
##  6   -12 Warm Infected    14
##  7   -12 Cold Control     10
##  8   -12 Cold Infected    14
##  9     0 Warm Control     10
## 10     0 Warm Infected    14
## # ℹ 42 more rows
```
Save CSV
